...
//	public ChapterResponse getChapterByBookIdAndChapterId(@Param("bookId") Integer bookId, @Param("chapterId") Integer chapterId);
	...
	@Query("select new com.edumoca.soma.entities.models.ChapterResponse(bcm.chapter.chapterId,bcm.chapter.name) from BookChapterMap bcm where bcm.book.bookId= :bookId")
	public List<ChapterResponse> getChapterListByBookId(@Param("bookId") Integer bookId);
}
