...
public class GradeSectionInstitutionYearMap extends BaseEntity{
	@Id
    ...
    private GradeSectionInstitutionMap gradeSectionInstitutionMap;
    @ManyToOne
    @JoinColumn(name = "ACADEMIC_YEAR_ID",referencedColumnName = "ID")
    private AcademicYear academicYear;
    @OneToMany(mappedBy = "gradeSectionInstitutionYearMap")
